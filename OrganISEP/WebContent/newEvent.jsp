<ol class="breadcrumb" id="breadcrumb" style="display: none;">
	...
	<li class="breadcrumb-item sousTitre_event" id=eventTitre aria-current="page"></li>
	<li class="breadcrumb-item active sousTitre_event" id=eventTitre aria-current="page">Modification</li>
</ol>

<div id="editEvent">	
	<h3 id="titre">Créer un événement</h3>
...
function modifyEvent(event) {
	...
	document.getElementById("titre").innerText = "Modification de " + event.titre;
